...
router.get(`/`, async (req, res) => {
    // -passwordHash will remove it from presentation
...
router.get('/:id', async (req, res) => {
    ...
    if (!user) 
    {
        res.status(500).send({ message: 'The user with the given ID was not found.' })
    }
...
router.post('/login', async (req, res) => {
    try {
        ...
        {
            // if user and password match we will create token 
